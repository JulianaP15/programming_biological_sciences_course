# Programming for Biological Sciences – Course Projects

This repository contains my assignments and projects from the **Programming for Biological Sciences** course.  
Each folder corresponds to a project where I apply Python to real biological data formats.
